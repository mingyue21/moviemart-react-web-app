    ...
    return (
        show && (
            <div>
                ...
                <div className="justify-center mt-2">{getSeats()}</div>
                ...
                {selectedSeats.length > 0 && (
                    <div className="mt-2 flex justify-center gap-2 items-center flex-col">
                        ...
                        <StripeCheckout
                            ...
                            billingAddress
                            stripeKey="pk_test_51LPxsHB9TxsNRZBa1zNcXxXNyrJ8SUcG9NNdCZaxZpteqGsonx9flhRjvS8gTpRsPMwf51doxqeyI1ffCKBoXFOP00H2W65rjL"
                        >
